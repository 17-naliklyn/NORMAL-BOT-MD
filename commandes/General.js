...
zokou({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  repondre("THANK YOU FOR CHOOSING NALIKLYN, HERE ARE OUR SUPPORTIVE LINKS\n\n ☉ GROUP LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://chat.whatsapp.com/DFOAMrVITD61idKoYMDVvr] \n\n ☉YOUTUBE LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://youtube.com/@naliklyn?si=JW0xOn1Mjp0sUnjb] \n\n\n*Created By Mr CASE_KLYN") 
  await zk.sendMessage(auteurMessage,{text : `THANK YOU FOR CHOOSING NALIKLYN,MAKE SURE YOU FOLLOW THESE LINKS. `},{quoted :ms})
